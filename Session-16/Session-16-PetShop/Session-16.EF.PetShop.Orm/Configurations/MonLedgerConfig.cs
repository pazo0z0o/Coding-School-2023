...
namespace Session_16.EF.PetShop.Orm.Configurations
{
    public class MonLedgerConfig : IEntityTypeConfiguration<MonthlyLedger>
    {
        public void Configure(EntityTypeBuilder<MonthlyLedger> builder)
        {
            ...
            builder.Property(todo => todo.Income).HasMaxLength(15).HasPrecision(7,2).IsRequired(true);
            builder.Property(todo => todo.Expenses).HasMaxLength(15).HasPrecision(7,2).IsRequired(true);

            builder.Property(todo => todo.Total).HasMaxLength(15).IsRequired(true);
        }
    }
}
